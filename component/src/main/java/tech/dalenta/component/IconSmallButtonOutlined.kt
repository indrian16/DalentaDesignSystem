...
class IconSmallButtonOutlined(context: Context, attrs: AttributeSet?) : FrameLayout(context, attrs) {
    ...
    init {
        ...
        // Get Dimension
        val dimensionWidth = attributes.getLayoutDimension(R.styleable.IconSmallButtonOutlined_android_layout_width, LayoutParams.WRAP_CONTENT)
        val dimensionHeight = attributes.getLayoutDimension(R.styleable.IconSmallButtonOutlined_android_layout_height, LayoutParams.WRAP_CONTENT)
